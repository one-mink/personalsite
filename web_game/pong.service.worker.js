...
/** @type {string} */
const CACHE_VERSION = '1764189016|2893164537';
/** @type {string} */
const CACHE_PREFIX = 'pongbong-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["pong.html","pong.js","pong.offline.html","pong.icon.png","pong.apple-touch-icon.png","pong.audio.worklet.js","pong.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["pong.wasm","pong.pck"];
